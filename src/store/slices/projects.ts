  ...
  projects: [
    {
      ...
      name: 'AURA TMA',
      description: `To integrate with TON, the standard wallet connection protocol is used — TON Connect.
         It is similar to WalletConnect on Ethereum, but made specifically for TON and covers basic integration aspects. 
         For deeper integrations, it’s common to utilize various supplementary SDKs and APIs. 
         To integrate with TON, the standard wallet connection protocol is used — TON Connect. 
         It is similar to WalletConnect on Ethereum, but made specifically for TON and covers basic integration aspects. 
         For deeper integrations, it’s common to utilize various supplementary SDKs and APIs.`,
